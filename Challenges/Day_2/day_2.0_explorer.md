...
Congratulations! You've completed Day 2 of the Bash Scripting Challenge. The challenge focuses on Command-Line Argument Parsing to build an script that explores files, directories. Happy scripting and exploring!
